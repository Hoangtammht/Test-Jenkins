...
public class ESMService {
    ...
    public ResponseSendOTP sendOTP(String phoneNumber) throws IOException {
        ...
        String url = "http://rest.esms.vn/MainService.svc/json/SendMessageAutoGenCode_V4_get?Phone="+encodedPhone+"&ApiKey="+APIKey+"&SecretKey="+SecretKey+"&TimeAlive=3&NumCharOfCode=4&Brandname=Baotrixemay&Type=2&message="+encodedMessage;
